#!/usr/bin/env python3
"""
Send 5-day weather forecast for East Hanover, NJ via AgentMail using top-level messages.send.
"""
import os
import sys
import json
...
def send_weather_email(location, days=5, recipient=None, subject=None):
    ...
    # Send via AgentMail using top-level messages.send (no inbox_id needed)
    try:
        ...
        # Use the top-level messages.send method (does not require inbox_id)
