#!/usr/bin/env python3
"""
Send 5-day weather forecast for Boston via AgentMail with precipitation and wind in US Customary Units.
"""
import os
import sys
import json
...
def fetch_5day_forecast():
    """Fetch 5-day daily forecast for Boston from Open-Meteo."""
    # Boston coordinates
    latitude = 42.3601
    longitude = -71.0589
...
def format_forecast(data):
    ...
    lines = ["Boston 5-Day Forecast (US Customary Units):"]
...
def send_weather_email():
    ...
    response = client.inboxes.messages.send(
        ...
        subject="Boston 5-Day Weather Forecast with Precipitation & Wind (US Customary Units)",
        text=body
    )
